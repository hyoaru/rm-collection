        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 sm:col-span-3 lg:col-span-2">
            <div className="flex flex-col gap-2">
              <div className="bg-primary p-2 flex flex-row overflow-x-auto rounded-lg gap-2 sm:flex-col">
              ...
              <div className="border border-x-0 p-2 flex flex-row overflow-x-auto rounded-lg gap-2 sm:flex-col">
