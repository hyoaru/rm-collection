...
export default function OrderCancelledByUser({ orders }: OrderPendingProps) {
  ...
  const orderUpdatedAtDateFormatted = dayjs(firstOrderItem.updated_at).format("MMM DD, YYYY HH:mm ");
        ...
        <Body className="bg-white my-auto mx-auto font-serif px-2 pb-20">
          <Container>
            <Section className="text-center">
              ...
              <Text className="pb-3 text-lg font-bold">Order cancelled by user</Text>
            </Section>
            <Section className="mx-auto px-10">
              ...
              <Section className="px-5 text-sm">
                <Section className="opacity-70">
                  ...
                  <Text>
                    We received your request to cancel your order #{firstOrderItem.order_group} on{" "}
                    {orderUpdatedAtDateFormatted}. We wish you enjoy shopping with us and hope to see you again real
                    soon!
                  </Text>
                </Section>
              </Section>
