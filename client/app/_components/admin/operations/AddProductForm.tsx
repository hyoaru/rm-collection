...
export default function AddProductForm() {
  ...
  const onSubmit = useCallback(
    ...
    [form, resetImageFields, toast, addProductWithVariantMutation, selectedStockLocations]
  );
              ...
              <div className="grid grid-cols-12 gap-4 gap-y-2">
                ...
                <div className="col-span-12 grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="col-span-2 space-y-2">
                    ...
                    <CountriesMultiSelect selected={selectedStockLocations} setSelected={setSelectedStockLocations} />
                  </div>
